...
export class ReqImeiComponent implements OnInit {
  ...
  getModellist() {
    ...
    var url = `https://mvt.apmkingstrack.com/fleettracking/esim/getDealerCAStatusAll?companyid=${localStorage.getItem(
      'userId'
    )}&invoiceno=&serialno=&dealer=${localStorage.getItem('userId')}`;
